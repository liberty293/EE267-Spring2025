...
var FoveatedRenderer = function ( webglRenderer, dispParams ) {
	...
	// THREE.PlaneGeometry( 2, 2 ) creates four vertices (-1,1,0),
	...
	function computePixelVA( pixelPitch, distanceScreenViewer ) {
		...
		return 2*Math.atan(pixelPitch/2/distanceScreenViewer)*180/Math.PI;
